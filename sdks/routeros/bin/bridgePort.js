...
exports.BridgePort = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class BridgePort extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new BridgePort(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
exports.BridgePort = BridgePort;
/** @internal */
BridgePort.__pulumiType = 'routeros:index/bridgePort:BridgePort';
