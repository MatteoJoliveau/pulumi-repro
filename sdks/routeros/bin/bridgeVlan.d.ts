...
export declare class BridgeVlan extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BridgeVlanState, opts?: pulumi.CustomResourceOptions): BridgeVlan;
    /**
     * Returns true if the given object is an instance of BridgeVlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BridgeVlan;
    /**
    ...
    readonly bridgeVlanId: pulumi.Output<string>;
...
export interface BridgeVlanState {
    ...
    bridgeVlanId?: pulumi.Input<string>;
