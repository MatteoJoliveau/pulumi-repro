...
export declare class FirewallMangle extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallMangleState, opts?: pulumi.CustomResourceOptions): FirewallMangle;
    /**
     * Returns true if the given object is an instance of FirewallMangle.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FirewallMangle;
    /**
    ...
    readonly firewallMangleId: pulumi.Output<string>;
    /**
...
export interface FirewallMangleState {
    ...
    firewallMangleId?: pulumi.Input<string>;
    /**
     * Matches fragmented packets. First (starting) fragment does not count. If connection tracking is enabled there will be no
     * fragments as system automatically assembles every packet
     */
