...
export declare class FirewallNat extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FirewallNatState, opts?: pulumi.CustomResourceOptions): FirewallNat;
    /**
     * Returns true if the given object is an instance of FirewallNat.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FirewallNat;
    /**
    ...
    readonly firewallNatId: pulumi.Output<string>;
    /**
...
export interface FirewallNatState {
    ...
    firewallNatId?: pulumi.Input<string>;
    /**
     * Matches fragmented packets. First (starting) fragment does not count. If connection tracking is enabled there will be no
     * fragments as system automatically assembles every packet
     */
