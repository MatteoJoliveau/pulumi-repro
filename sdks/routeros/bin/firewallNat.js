...
exports.FirewallNat = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class FirewallNat extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new FirewallNat(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["firewallNatId"] = state ? state.firewallNatId : undefined;
            ...
            resourceInputs["firewallNatId"] = args ? args.firewallNatId : undefined;
        ...
        super(FirewallNat.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.FirewallNat = FirewallNat;
/** @internal */
FirewallNat.__pulumiType = 'routeros:index/firewallNat:FirewallNat';
//# sourceMappingURL=firewallNat.js.map