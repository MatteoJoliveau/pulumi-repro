...
export declare class Gre extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GreState, opts?: pulumi.CustomResourceOptions): Gre;
    /**
     * Returns true if the given object is an instance of Gre.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Gre;
    /**
    ...
    readonly greId: pulumi.Output<string>;
    /**
