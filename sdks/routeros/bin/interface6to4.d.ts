...
export declare class Interface6to4 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Interface6to4State, opts?: pulumi.CustomResourceOptions): Interface6to4;
    /**
     * Returns true if the given object is an instance of Interface6to4.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Interface6to4;
    /**
    ...
    readonly interface6to4Id: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a Interface6to4 resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: Interface6to4Args, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering Interface6to4 resources.
 */
export interface Interface6to4State {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ...
    interface6to4Id?: pulumi.Input<string>;
    /**
     * When secret is specified, router adds dynamic IPsec peer to remote-address with pre-shared key and policy (by default
     * phase2 uses sha1/aes128cbc).
     */
...
/**
 * The set of arguments for constructing a Interface6to4 resource.
 */
export interface Interface6to4Args {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
