...
export declare class InterfaceBridge extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceBridgeState, opts?: pulumi.CustomResourceOptions): InterfaceBridge;
    /**
     * Returns true if the given object is an instance of InterfaceBridge.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InterfaceBridge;
    /**
    ...
    readonly interfaceBridgeId: pulumi.Output<string>;
    /**
...
export interface InterfaceBridgeState {
    ...
    interfaceBridgeId?: pulumi.Input<string>;
    /**
     * Layer2 Maximum transmission unit. [See](https://wiki.mikrotik.com/wiki/Maximum_Transmission_Unit_on_RouterBoards).
     */
