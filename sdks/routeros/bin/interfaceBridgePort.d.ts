...
export declare class InterfaceBridgePort extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceBridgePortState, opts?: pulumi.CustomResourceOptions): InterfaceBridgePort;
    /**
     * Returns true if the given object is an instance of InterfaceBridgePort.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InterfaceBridgePort;
    /**
    ...
    readonly interfaceBridgePortId: pulumi.Output<string>;
    /**
...
export interface InterfaceBridgePortState {
    ...
    interfaceBridgePortId?: pulumi.Input<string>;
    /**
     * Path cost to the interface for MSTI0 inside a region. This property only has effect when protocol-mode is set to mstp.
     */
