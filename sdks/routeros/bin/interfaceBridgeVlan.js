...
exports.InterfaceBridgeVlan = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class InterfaceBridgeVlan extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new InterfaceBridgeVlan(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["interfaceBridgeVlanId"] = state ? state.interfaceBridgeVlanId : undefined;
            ...
            resourceInputs["interfaceBridgeVlanId"] = args ? args.interfaceBridgeVlanId : undefined;
        ...
        super(InterfaceBridgeVlan.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.InterfaceBridgeVlan = InterfaceBridgeVlan;
/** @internal */
InterfaceBridgeVlan.__pulumiType = 'routeros:index/interfaceBridgeVlan:InterfaceBridgeVlan';
//# sourceMappingURL=interfaceBridgeVlan.js.map