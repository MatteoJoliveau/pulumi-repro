...
exports.InterfaceGre = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class InterfaceGre extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new InterfaceGre(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["interfaceGreId"] = state ? state.interfaceGreId : undefined;
            ...
            resourceInputs["interfaceGreId"] = args ? args.interfaceGreId : undefined;
        ...
        super(InterfaceGre.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.InterfaceGre = InterfaceGre;
/** @internal */
InterfaceGre.__pulumiType = 'routeros:index/interfaceGre:InterfaceGre';
//# sourceMappingURL=interfaceGre.js.map