...
export declare class InterfaceIpip extends pulumi.CustomResource {
    /**
     * Get an existing InterfaceIpip resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceIpipState, opts?: pulumi.CustomResourceOptions): InterfaceIpip;
    /**
     * Returns true if the given object is an instance of InterfaceIpip.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InterfaceIpip;
    /**
    ...
    readonly interfaceIpipId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a InterfaceIpip resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: InterfaceIpipArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering InterfaceIpip resources.
 */
export interface InterfaceIpipState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ...
    interfaceIpipId?: pulumi.Input<string>;
    /**
     * When secret is specified, router adds dynamic IPsec peer to remote-address with pre-shared key and policy (by default
     * phase2 uses sha1/aes128cbc).
     */
...
/**
 * The set of arguments for constructing a InterfaceIpip resource.
 */
export interface InterfaceIpipArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
