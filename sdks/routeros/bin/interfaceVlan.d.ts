...
export declare class InterfaceVlan extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceVlanState, opts?: pulumi.CustomResourceOptions): InterfaceVlan;
    /**
     * Returns true if the given object is an instance of InterfaceVlan.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InterfaceVlan;
    /**
    ...
    readonly interfaceVlanId: pulumi.Output<string>;
    /**
...
export interface InterfaceVlanState {
    ...
    interfaceVlanId?: pulumi.Input<string>;
    /**
     * Layer2 Maximum transmission unit. [See](https://wiki.mikrotik.com/wiki/Maximum_Transmission_Unit_on_RouterBoards).
     */
