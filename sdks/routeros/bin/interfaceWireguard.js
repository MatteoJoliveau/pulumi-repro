...
exports.InterfaceWireguard = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class InterfaceWireguard extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new InterfaceWireguard(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["interfaceWireguardId"] = state ? state.interfaceWireguardId : undefined;
            ...
            resourceInputs["interfaceWireguardId"] = args ? args.interfaceWireguardId : undefined;
        ...
        super(InterfaceWireguard.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.InterfaceWireguard = InterfaceWireguard;
/** @internal */
InterfaceWireguard.__pulumiType = 'routeros:index/interfaceWireguard:InterfaceWireguard';
//# sourceMappingURL=interfaceWireguard.js.map