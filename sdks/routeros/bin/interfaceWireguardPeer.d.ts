...
export declare class InterfaceWireguardPeer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceWireguardPeerState, opts?: pulumi.CustomResourceOptions): InterfaceWireguardPeer;
    /**
     * Returns true if the given object is an instance of InterfaceWireguardPeer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InterfaceWireguardPeer;
    /**
    ...
    readonly interfaceWireguardPeerId: pulumi.Output<string>;
    /**
...
export interface InterfaceWireguardPeerState {
    ...
    interfaceWireguardPeerId?: pulumi.Input<string>;
    /**
     * Specifies if peer is intended to be connection initiator or only responder. Should be used on WireGuard devices that are
     * used as `servers` for other devices as clients to connect to. Otherwise router will all repeatedly try to connect
     * `endpoint-address` or `current-endpoint-address` causing unnecessary system logs to be written.
