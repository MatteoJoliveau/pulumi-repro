...
export declare class IpDhcpServer extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpDhcpServerState, opts?: pulumi.CustomResourceOptions): IpDhcpServer;
    /**
     * Returns true if the given object is an instance of IpDhcpServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpDhcpServer;
    /**
    ...
    readonly ipDhcpServerId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a IpDhcpServer resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IpDhcpServerArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering IpDhcpServer resources.
 */
export interface IpDhcpServerState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ...
    ipDhcpServerId?: pulumi.Input<string>;
    /**
     * A script that will be executed after a lease is assigned or de-assigned.
     */
...
/**
 * The set of arguments for constructing a IpDhcpServer resource.
 */
export interface IpDhcpServerArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
