...
export declare class IpDhcpServerLease extends pulumi.CustomResource {
    /**
     * Get an existing IpDhcpServerLease resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpDhcpServerLeaseState, opts?: pulumi.CustomResourceOptions): IpDhcpServerLease;
    /**
     * Returns true if the given object is an instance of IpDhcpServerLease.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpDhcpServerLease;
    /**
    ...
    readonly ipDhcpServerLeaseId: pulumi.Output<string>;
    ...
    /**
     * Create a IpDhcpServerLease resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IpDhcpServerLeaseArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering IpDhcpServerLease resources.
 */
export interface IpDhcpServerLeaseState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ...
    ipDhcpServerLeaseId?: pulumi.Input<string>;
...
/**
 * The set of arguments for constructing a IpDhcpServerLease resource.
 */
export interface IpDhcpServerLeaseArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
