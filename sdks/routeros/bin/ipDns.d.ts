...
export declare class IpDns extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpDnsState, opts?: pulumi.CustomResourceOptions): IpDns;
    /**
     * Returns true if the given object is an instance of IpDns.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpDns;
    /**
    ...
    readonly ipDnsId: pulumi.Output<string>;
    /**
