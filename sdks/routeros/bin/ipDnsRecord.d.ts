...
export declare class IpDnsRecord extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpDnsRecordState, opts?: pulumi.CustomResourceOptions): IpDnsRecord;
    /**
     * Returns true if the given object is an instance of IpDnsRecord.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpDnsRecord;
    /**
    ...
    readonly ipDnsRecordId: pulumi.Output<string>;
    /**
