...
export declare class IpFirewallFilter extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpFirewallFilterState, opts?: pulumi.CustomResourceOptions): IpFirewallFilter;
    /**
     * Returns true if the given object is an instance of IpFirewallFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpFirewallFilter;
    /**
    ...
    readonly ipFirewallFilterId: pulumi.Output<string>;
    /**
...
export interface IpFirewallFilterState {
    ...
    ipFirewallFilterId?: pulumi.Input<string>;
    /**
     * Matches the policy used by IPsec. Value is written in the following format: direction, policy.
     */
