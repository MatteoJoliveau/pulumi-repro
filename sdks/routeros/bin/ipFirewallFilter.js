...
exports.IpFirewallFilter = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class IpFirewallFilter extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new IpFirewallFilter(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ipFirewallFilterId"] = state ? state.ipFirewallFilterId : undefined;
            ...
            resourceInputs["ipFirewallFilterId"] = args ? args.ipFirewallFilterId : undefined;
        ...
        super(IpFirewallFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.IpFirewallFilter = IpFirewallFilter;
/** @internal */
IpFirewallFilter.__pulumiType = 'routeros:index/ipFirewallFilter:IpFirewallFilter';
//# sourceMappingURL=ipFirewallFilter.js.map