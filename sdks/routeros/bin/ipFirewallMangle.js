...
exports.IpFirewallMangle = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class IpFirewallMangle extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new IpFirewallMangle(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ipFirewallMangleId"] = state ? state.ipFirewallMangleId : undefined;
            ...
            resourceInputs["ipFirewallMangleId"] = args ? args.ipFirewallMangleId : undefined;
        ...
        super(IpFirewallMangle.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.IpFirewallMangle = IpFirewallMangle;
/** @internal */
IpFirewallMangle.__pulumiType = 'routeros:index/ipFirewallMangle:IpFirewallMangle';
//# sourceMappingURL=ipFirewallMangle.js.map