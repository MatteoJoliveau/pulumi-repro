...
export declare class IpFirewallNat extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpFirewallNatState, opts?: pulumi.CustomResourceOptions): IpFirewallNat;
    /**
     * Returns true if the given object is an instance of IpFirewallNat.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IpFirewallNat;
    /**
    ...
    readonly ipFirewallNatId: pulumi.Output<string>;
    /**
     ...
     */
    readonly randomisePorts: pulumi.Output<boolean | undefined>;
    /**
     ...
     * if action=same
     */
    readonly sameNotByDst: pulumi.Output<boolean | undefined>;
    /**
...
export interface IpFirewallNatState {
    ...
    ipFirewallNatId?: pulumi.Input<string>;
    /**
     * Matches the policy used by IPsec. Value is written in the following format: direction, policy.
     */
     ...
     * Randomize to which public port connections will be mapped.
     */
    randomisePorts?: pulumi.Input<boolean>;
    /**
     * Matches packets marked by mangle facility with particular routing mark.
     */
