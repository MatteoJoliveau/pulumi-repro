...
exports.IpFirewallNat = void 0;
const pulumi = require("@pulumi/pulumi");
const utilities = require("./utilities");
class IpFirewallNat extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new IpFirewallNat(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["ipFirewallNatId"] = state ? state.ipFirewallNatId : undefined;
            ...
            resourceInputs["randomisePorts"] = state ? state.randomisePorts : undefined;
            ...
            resourceInputs["ipFirewallNatId"] = args ? args.ipFirewallNatId : undefined;
            ...
            resourceInputs["randomisePorts"] = args ? args.randomisePorts : undefined;
        ...
        super(IpFirewallNat.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.IpFirewallNat = IpFirewallNat;
/** @internal */
IpFirewallNat.__pulumiType = 'routeros:index/ipFirewallNat:IpFirewallNat';
//# sourceMappingURL=ipFirewallNat.js.map