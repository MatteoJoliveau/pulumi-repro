...
export declare class Ipip extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpipState, opts?: pulumi.CustomResourceOptions): Ipip;
    /**
     * Returns true if the given object is an instance of Ipip.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Ipip;
    /**
    ...
    readonly ipipId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a Ipip resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: IpipArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering Ipip resources.
 */
...
/**
 * The set of arguments for constructing a Ipip resource.
 */
export interface IpipArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
