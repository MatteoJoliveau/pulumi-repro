...
export declare class Ipv6FirewallFilter extends pulumi.CustomResource {
    /**
     * Get an existing Ipv6FirewallFilter resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Ipv6FirewallFilterState, opts?: pulumi.CustomResourceOptions): Ipv6FirewallFilter;
    /**
     * Returns true if the given object is an instance of Ipv6FirewallFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Ipv6FirewallFilter;
    /**
     ...
     */
    readonly addressListTimeout: pulumi.Output<string>;
    /**
     ...
     */
    readonly hopLimit: pulumi.Output<string | undefined>;
    /**
    ...
    readonly ipv6FirewallFilterId: pulumi.Output<string>;
    /**
    ...
    /**
     * Create a Ipv6FirewallFilter resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: Ipv6FirewallFilterArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering Ipv6FirewallFilter resources.
 */
export interface Ipv6FirewallFilterState {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ...
    ipv6FirewallFilterId?: pulumi.Input<string>;
    /**
     * Name of the target chain to jump to. Applicable only if action=jump.
     */
...
/**
 * The set of arguments for constructing a Ipv6FirewallFilter resource.
 */
export interface Ipv6FirewallFilterArgs {
    /**
     * <em>Resource ID type (.id / name). This is an internal service field, setting a value is not required.</em>
     */
    ___id_?: pulumi.Input<number>;
