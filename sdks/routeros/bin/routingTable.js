...
class RoutingTable extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RoutingTable(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(RoutingTable.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
exports.RoutingTable = RoutingTable;
/** @internal */
RoutingTable.__pulumiType = 'routeros:index/routingTable:RoutingTable';
