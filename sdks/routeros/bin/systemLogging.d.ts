...
export declare class SystemLogging extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemLoggingState, opts?: pulumi.CustomResourceOptions): SystemLogging;
    /**
     * Returns true if the given object is an instance of SystemLogging.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SystemLogging;
    /**
    ...
    readonly systemLoggingId: pulumi.Output<string>;
    /**
