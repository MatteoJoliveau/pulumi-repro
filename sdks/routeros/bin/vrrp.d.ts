...
export declare class Vrrp extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VrrpState, opts?: pulumi.CustomResourceOptions): Vrrp;
    /**
     * Returns true if the given object is an instance of Vrrp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Vrrp;
    /**
    ...
    readonly vrrpId: pulumi.Output<string>;
    /**
