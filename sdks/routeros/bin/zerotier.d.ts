...
export declare class Zerotier extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ZerotierState, opts?: pulumi.CustomResourceOptions): Zerotier;
    /**
     * Returns true if the given object is an instance of Zerotier.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Zerotier;
    /**
     ...
     */
    readonly identityPublic: pulumi.Output<string>;
    /**
     ...
     */
    readonly online: pulumi.Output<boolean>;
    /**
    ...
    readonly zerotierId: pulumi.Output<string>;
    /**
