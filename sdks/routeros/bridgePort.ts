...
export class BridgePort extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'routeros:index/bridgePort:BridgePort';
    ...
    public readonly bridgePortId!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly mvrpApplicantState!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly mvrpRegistrarState!: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: BridgePortArgs | BridgePortState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["bridgePortId"] = state ? state.bridgePortId : undefined;
            ...
            resourceInputs["bridgePortId"] = args ? args.bridgePortId : undefined;
        ...
        super(BridgePort.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
