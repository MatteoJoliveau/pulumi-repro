...
export class CapsmanChannel extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CapsmanChannelState, opts?: pulumi.CustomResourceOptions): CapsmanChannel {
        return new CapsmanChannel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/capsmanChannel:CapsmanChannel';

    /**
     * Returns true if the given object is an instance of CapsmanChannel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CapsmanChannel {
    ...
    public readonly capsmanChannelId!: pulumi.Output<string>;
     ...
     */
    public readonly frequencies!: pulumi.Output<number[] | undefined>;
    ...
    constructor(name: string, argsOrState?: CapsmanChannelArgs | CapsmanChannelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CapsmanChannelState | undefined;
            ...
            const args = argsOrState as CapsmanChannelArgs | undefined;
