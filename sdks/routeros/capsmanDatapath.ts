...
export class CapsmanDatapath extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CapsmanDatapathState, opts?: pulumi.CustomResourceOptions): CapsmanDatapath {
        return new CapsmanDatapath(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/capsmanDatapath:CapsmanDatapath';

    /**
     * Returns true if the given object is an instance of CapsmanDatapath.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CapsmanDatapath {
    ...
    public readonly capsmanDatapathId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: CapsmanDatapathArgs | CapsmanDatapathState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CapsmanDatapathState | undefined;
            ...
            const args = argsOrState as CapsmanDatapathArgs | undefined;
