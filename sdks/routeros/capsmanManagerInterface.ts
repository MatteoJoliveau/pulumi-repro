...
export class CapsmanManagerInterface extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CapsmanManagerInterfaceState, opts?: pulumi.CustomResourceOptions): CapsmanManagerInterface {
        return new CapsmanManagerInterface(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/capsmanManagerInterface:CapsmanManagerInterface';

    /**
     * Returns true if the given object is an instance of CapsmanManagerInterface.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CapsmanManagerInterface {
    ...
    public readonly capsmanManagerInterfaceId!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: CapsmanManagerInterfaceArgs | CapsmanManagerInterfaceState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CapsmanManagerInterfaceState | undefined;
            ...
            const args = argsOrState as CapsmanManagerInterfaceArgs | undefined;
