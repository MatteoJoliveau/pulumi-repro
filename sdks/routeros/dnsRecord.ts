...
export class DnsRecord extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'routeros:index/dnsRecord:DnsRecord';
    ...
    public readonly dnsRecordId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: DnsRecordArgs | DnsRecordState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["dnsRecordId"] = args ? args.dnsRecordId : undefined;
