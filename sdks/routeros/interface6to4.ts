...
export class Interface6to4 extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Interface6to4State, opts?: pulumi.CustomResourceOptions): Interface6to4 {
        return new Interface6to4(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/interface6to4:Interface6to4';

    /**
     * Returns true if the given object is an instance of Interface6to4.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Interface6to4 {
    ...
    public readonly interface6to4Id!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: Interface6to4Args | Interface6to4State, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Interface6to4State | undefined;
            ...
            const args = argsOrState as Interface6to4Args | undefined;
