...
export class InterfaceIpip extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterfaceIpipState, opts?: pulumi.CustomResourceOptions): InterfaceIpip {
        return new InterfaceIpip(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/interfaceIpip:InterfaceIpip';

    /**
     * Returns true if the given object is an instance of InterfaceIpip.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InterfaceIpip {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InterfaceIpip.__pulumiType;
    }
    ...
    public readonly interfaceIpipId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: InterfaceIpipArgs | InterfaceIpipState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as InterfaceIpipState | undefined;
            ...
            resourceInputs["interfaceIpipId"] = state ? state.interfaceIpipId : undefined;
            ...
            const args = argsOrState as InterfaceIpipArgs | undefined;
            ...
            resourceInputs["interfaceIpipId"] = args ? args.interfaceIpipId : undefined;
        ...
        super(InterfaceIpip.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
