...
export class InterfaceWireguardPeer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'routeros:index/interfaceWireguardPeer:InterfaceWireguardPeer';
     ...
     * device.
     */
    public readonly clientAddress!: pulumi.Output<string | undefined>;
    /**
     * Specify when using WireGuard Server as a VPN gateway for peer traffic.
     */
    public readonly clientDns!: pulumi.Output<string | undefined>;
    /**
     * The IP address and port number of the WireGuard Server.
     */
    public readonly clientEndpoint!: pulumi.Output<string | undefined>;
    /**
     * Same as persistent-keepalive but from peer side.
     */
    public readonly clientKeepalive!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly clientListenPort!: pulumi.Output<number | undefined>;
    ...
    public readonly interfaceWireguardPeerId!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly isResponder!: pulumi.Output<boolean | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InterfaceWireguardPeerArgs | InterfaceWireguardPeerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["interfaceWireguardPeerId"] = state ? state.interfaceWireguardPeerId : undefined;
            ...
            resourceInputs["interfaceWireguardPeerId"] = args ? args.interfaceWireguardPeerId : undefined;
        ...
        super(InterfaceWireguardPeer.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
