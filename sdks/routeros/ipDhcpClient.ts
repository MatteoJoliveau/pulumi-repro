...
export class IpDhcpClient extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpDhcpClientState, opts?: pulumi.CustomResourceOptions): IpDhcpClient {
        return new IpDhcpClient(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipDhcpClient:IpDhcpClient';

    /**
     * Returns true if the given object is an instance of IpDhcpClient.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpDhcpClient {
    ...
    public readonly ipDhcpClientId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: IpDhcpClientArgs | IpDhcpClientState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpDhcpClientState | undefined;
            ...
            const args = argsOrState as IpDhcpClientArgs | undefined;
