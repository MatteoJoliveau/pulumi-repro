...
export class IpDhcpServer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpDhcpServerState, opts?: pulumi.CustomResourceOptions): IpDhcpServer {
        return new IpDhcpServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipDhcpServer:IpDhcpServer';

    /**
     * Returns true if the given object is an instance of IpDhcpServer.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpDhcpServer {
    ...
    public readonly ipDhcpServerId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: IpDhcpServerArgs | IpDhcpServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpDhcpServerState | undefined;
            ...
            const args = argsOrState as IpDhcpServerArgs | undefined;
