...
export class IpFirewallRaw extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpFirewallRawState, opts?: pulumi.CustomResourceOptions): IpFirewallRaw {
        return new IpFirewallRaw(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipFirewallRaw:IpFirewallRaw';

    /**
     * Returns true if the given object is an instance of IpFirewallRaw.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpFirewallRaw {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IpFirewallRaw.__pulumiType;
    }
    ...
    public readonly ipFirewallRawId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: IpFirewallRawArgs | IpFirewallRawState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpFirewallRawState | undefined;
            ...
            resourceInputs["ipFirewallRawId"] = state ? state.ipFirewallRawId : undefined;
            ...
            const args = argsOrState as IpFirewallRawArgs | undefined;
            ...
            resourceInputs["ipFirewallRawId"] = args ? args.ipFirewallRawId : undefined;
        ...
        super(IpFirewallRaw.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
