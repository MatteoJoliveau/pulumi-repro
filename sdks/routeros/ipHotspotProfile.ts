...
export class IpHotspotProfile extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpHotspotProfileState, opts?: pulumi.CustomResourceOptions): IpHotspotProfile {
        return new IpHotspotProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipHotspotProfile:IpHotspotProfile';

    /**
     * Returns true if the given object is an instance of IpHotspotProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpHotspotProfile {
     ...
     */
    public readonly hotspotAddress!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly htmlDirectory!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly htmlDirectoryOverride!: pulumi.Output<string | undefined>;
    /**
     * HTTP cookie validity time, the option is related to cookie HotSpot login method.
     */
    public readonly httpCookieLifetime!: pulumi.Output<string | undefined>;
    /**
    ...
    public readonly ipHotspotProfileId!: pulumi.Output<string>;
    /**
     ...
     */
    public readonly loginBies!: pulumi.Output<string[] | undefined>;
    /**
     ...
     * blank password.
     */
    public readonly macAuthPassword!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly nasPortType!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly radiusDefaultDomain!: pulumi.Output<string | undefined>;
    /**
     * How often to send accounting updates . When received is set, interim-time is used from RADIUS server. 0s is the same as
     * received.
     */
    public readonly radiusInterimUpdate!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly radiusLocationName!: pulumi.Output<string | undefined>;
    /**
     ...
     * server.
     */
    public readonly splitUserDomain!: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    public readonly trialUptimeLimit!: pulumi.Output<string | undefined>;
    /**
     * Used only with trial authentication method.
     */
    public readonly trialUptimeReset!: pulumi.Output<string | undefined>;
    /**
     * Specifies hotspot user profile for trial users.
     */
    public readonly trialUserProfile!: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: IpHotspotProfileArgs | IpHotspotProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpHotspotProfileState | undefined;
            ...
            const args = argsOrState as IpHotspotProfileArgs | undefined;
            ...
            resourceInputs["macAuthPassword"] = args?.macAuthPassword ? pulumi.secret(args.macAuthPassword) : undefined;
