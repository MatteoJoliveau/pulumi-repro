...
export class IpIpsecKey extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpIpsecKeyState, opts?: pulumi.CustomResourceOptions): IpIpsecKey {
        return new IpIpsecKey(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipIpsecKey:IpIpsecKey';

    /**
     * Returns true if the given object is an instance of IpIpsecKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpIpsecKey {
    ...
    public readonly ipIpsecKeyId!: pulumi.Output<string>;
    /**
     * Size of this key.
     */
    ...
    constructor(name: string, argsOrState?: IpIpsecKeyArgs | IpIpsecKeyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpIpsecKeyState | undefined;
            ...
            const args = argsOrState as IpIpsecKeyArgs | undefined;
