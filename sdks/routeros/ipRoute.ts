...
export class IpRoute extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpRouteState, opts?: pulumi.CustomResourceOptions): IpRoute {
        return new IpRoute(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipRoute:IpRoute';

    /**
     * Returns true if the given object is an instance of IpRoute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is IpRoute {
    ...
    public readonly ipRouteId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: IpRouteArgs | IpRouteState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpRouteState | undefined;
            ...
            const args = argsOrState as IpRouteArgs | undefined;
