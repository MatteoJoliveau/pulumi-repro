...
export class Ipip extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IpipState, opts?: pulumi.CustomResourceOptions): Ipip {
        return new Ipip(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipip:Ipip';

    /**
     * Returns true if the given object is an instance of Ipip.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ipip {
    ...
    public readonly ipipId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: IpipArgs | IpipState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as IpipState | undefined;
            ...
            const args = argsOrState as IpipArgs | undefined;
