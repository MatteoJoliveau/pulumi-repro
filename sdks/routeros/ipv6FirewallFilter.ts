...
export class Ipv6FirewallFilter extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Ipv6FirewallFilterState, opts?: pulumi.CustomResourceOptions): Ipv6FirewallFilter {
        return new Ipv6FirewallFilter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/ipv6FirewallFilter:Ipv6FirewallFilter';

    /**
     * Returns true if the given object is an instance of Ipv6FirewallFilter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Ipv6FirewallFilter {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Ipv6FirewallFilter.__pulumiType;
    }
    ...
    public readonly ipv6FirewallFilterId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: Ipv6FirewallFilterArgs | Ipv6FirewallFilterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as Ipv6FirewallFilterState | undefined;
            ...
            resourceInputs["ipv6FirewallFilterId"] = state ? state.ipv6FirewallFilterId : undefined;
            ...
            const args = argsOrState as Ipv6FirewallFilterArgs | undefined;
            ...
            resourceInputs["ipv6FirewallFilterId"] = args ? args.ipv6FirewallFilterId : undefined;
        ...
        super(Ipv6FirewallFilter.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
