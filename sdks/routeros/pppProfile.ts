...
export class PppProfile extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PppProfileState, opts?: pulumi.CustomResourceOptions): PppProfile {
        return new PppProfile(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/pppProfile:PppProfile';

    /**
     * Returns true if the given object is an instance of PppProfile.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is PppProfile {
    ...
    public readonly pppProfileId!: pulumi.Output<string>;
    /**
     * Queue types.
     */
    ...
    constructor(name: string, argsOrState?: PppProfileArgs | PppProfileState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as PppProfileState | undefined;
            ...
            const args = argsOrState as PppProfileArgs | undefined;
