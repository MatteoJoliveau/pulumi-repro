...
export class SystemCertificate extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SystemCertificateState, opts?: pulumi.CustomResourceOptions): SystemCertificate {
        return new SystemCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'routeros:index/systemCertificate:SystemCertificate';

    /**
     * Returns true if the given object is an instance of SystemCertificate.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is SystemCertificate {
     ...
     */
    public /*out*/ readonly challengePassword!: pulumi.Output<string>;
    /**
    ...
    public readonly imports!: pulumi.Output<outputs.SystemCertificateImport[] | undefined>;
    /**
    ...
    public readonly signViaSceps!: pulumi.Output<outputs.SystemCertificateSignViaScep[] | undefined>;
    public readonly signs!: pulumi.Output<outputs.SystemCertificateSign[] | undefined>;
    /**
    ...
    public readonly systemCertificateId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: SystemCertificateArgs | SystemCertificateState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as SystemCertificateState | undefined;
            ...
            const args = argsOrState as SystemCertificateArgs | undefined;
