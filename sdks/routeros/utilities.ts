...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("routeros");
			params.setVersion("1.70.0");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL3RlcnJhZm9ybS1yb3V0ZXJvcy9yb3V0ZXJvcyIsInZlcnNpb24iOiIxLjcwLjAifX0="), c => c.charCodeAt(0)));
