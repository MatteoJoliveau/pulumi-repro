...
export class Vrrp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'routeros:index/vrrp:Vrrp';
     ...
     */
    public readonly groupAuthority!: pulumi.Output<string | undefined>;
    /**
     * Allows combining multiple VRRP interfaces to maintain the same VRRP status within the group. `group_authority` was
     * previously called `group_master`, `group_master` is kept for compatibility with scripts, but if both are set only
     * `group_authority` will be taken into account.
     */
    public readonly groupMaster!: pulumi.Output<string | undefined>;
    /**
    ...
    public readonly vrrpId!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: VrrpArgs | VrrpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Vrrp.__pulumiType, name, resourceInputs, opts, false /*dependency*/, utilities.getPackage());
    }
}
